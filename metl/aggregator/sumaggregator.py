...
class SumAggregator( metl.aggregator.base.Aggregator ):
    ...
    def __init__( self, reader, fieldNames, targetFieldName, valueFieldName, listFieldName = None, *args, **kwargs ):
        ...
        super( SumAggregator, self ).__init__( reader, fieldNames, targetFieldName, listFieldName, *args, **kwargs )

    def aggregate( self, records ):

        return sum([ r.getField( self.valueFieldName ).getValue() or 0 for r in records ])